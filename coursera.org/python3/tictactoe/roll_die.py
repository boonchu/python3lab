...
def roll_die(num_sides):
    ...
    """
    result = random.randrange(num_sides) + 1
    return result
...
def plot_fairness(side, num_sides, max_trials):
    ...
    simpleplot.plot_lines("Fairness test", 400, 300, "number of rolls", "mathematical - computed", [plot], False, ["plot"])

# check the fairness of the die
plot_fairness(1, 6, 3000)
