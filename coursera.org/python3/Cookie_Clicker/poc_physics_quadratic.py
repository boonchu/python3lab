...
def plot_performance(plot_length, plot_type):
    ...
    if plot_type == TIME_PLOT:
        simpleplot.plot_lines("Running time for quadratic update", 400, 400, "# balls", "time to update", [plot], True, ["Balls"])
    else:
        simpleplot.plot_lines("Comparison of running time to quadratic function", 400, 400, "# balls", "ratio", [plot], True, ["Balls"])
