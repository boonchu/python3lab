...
How many sequences of length four can be formed by choosing the first two elements
in the sequences from a set of outcomes of size x and the last two elements in the
sequences from a set of outcomes of size y?

In this case, repeated outcomes are allowed. 
'''
...
'''
set of outcomes = (x)^2 * (y)^2  = (4)^2 * (3)^2 = 16 * 9 = 144
'''
